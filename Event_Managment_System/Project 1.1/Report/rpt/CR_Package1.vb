...
Public Class CR_Package1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CR_Package1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Package1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Package1 = New CR_Package1()
        rpt.Site = Me.Site
        Return rpt
    End Function
