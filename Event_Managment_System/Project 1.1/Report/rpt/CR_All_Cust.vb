...
Public Class CR_All_Cust
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CR_All_Cust.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_All_Cust
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_All_Cust = New CR_All_Cust()
        rpt.Site = Me.Site
        Return rpt
    End Function
