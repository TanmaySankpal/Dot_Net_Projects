...
Public Class CR_Bill_Search
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CR_Bill_Search.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Bill_Search
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Bill_Search = New CR_Bill_Search()
        rpt.Site = Me.Site
        Return rpt
    End Function
