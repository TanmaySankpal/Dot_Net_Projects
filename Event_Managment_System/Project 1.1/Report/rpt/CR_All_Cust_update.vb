...
Public Class CR_All_Cust_update
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CR_All_Cust_update.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_All_Cust_update
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_All_Cust_update = New CR_All_Cust_update()
        rpt.Site = Me.Site
        Return rpt
    End Function
